function TopCard(props) {
    ...
    let rm = revision.meaning.map(meaning => <p className="card-text">{meaning}</p>)
    ...
    return (
        ...
        <div className="card" style={{width:"50vw","background" :"linear-gradient(to bottom, #f3e2c7 0%,#c19e67 50%,#b68d4c 51%,#e9d4b3 100%)"}}>
            ...
            <div className="card-body">
                <h5 className="card-title">{revision.word}</h5>
                <h6 className="card-subtitle mb-2 text-muted">{revision.type}</h6>
